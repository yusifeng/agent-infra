...
export const ui = {
  ...
  actionIcon:
    'flex items-center justify-center rounded-lg text-[color:var(--chat-text-secondary)] transition hover:bg-[var(--chat-hover)] hover:text-[color:var(--chat-text)] disabled:cursor-default disabled:opacity-70',
  threadAction:
  ...
  composerSecondaryButton:
    'flex h-8 w-8 items-center justify-center rounded-lg border border-[color:var(--chat-border)] bg-[var(--chat-surface)] text-[color:var(--chat-text-secondary)] transition hover:border-[color:var(--chat-border-strong)] hover:bg-[var(--chat-hover)] disabled:cursor-default disabled:opacity-75',
  ...
  composerMutedChip:
    'flex h-9 items-center gap-1 rounded-lg bg-slate-100 px-2.5 text-xs text-slate-400'
} as const;
