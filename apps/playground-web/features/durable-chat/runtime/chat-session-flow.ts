...
import { createThreadResponse, fetchRuntimeMetaResponse, fetchThreadsResponse } from '../repo/chat-api';
import { normalizeRuntimeMeta } from '../service/chat-runtime';
...
type ResetDraftThreadStateArgs = {
  refs: {
    ...
    logInspectorRequestIdRef: MutableRefObject<number>;
    messagesAbortControllerRef: MutableRefObject<AbortController | null>;
    messagesRequestIdRef: MutableRefObject<number>;
...
type InitializeRuntimeArgs = {
  ...
  refs: {
    runSelectionPersistenceReadyRef: MutableRefObject<boolean>;
  };
  actions: {
