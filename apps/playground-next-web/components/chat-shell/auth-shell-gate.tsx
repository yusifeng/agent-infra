...
type AuthShellGateProps = {
  children: (props: { currentUser: AuthUserDto; onLogout: () => void }) => ReactNode;
};
...
export function AuthShellGate({ children }: AuthShellGateProps) {
  ...
  return <>{children({ currentUser, onLogout: logout })}</>;
}
