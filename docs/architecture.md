...
- `packages/durable-chat-client`: browser-side headless durable chat transport, schema, state helpers, plus optional inspector primitives.
...
- `packages/durable-chat-client` owns reusable browser-side chat transport, normalization, headless state helpers, and optional inspector recovery primitives.
