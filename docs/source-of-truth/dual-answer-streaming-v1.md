...
- Feedback operations remain run-scoped `AnswerContainer` operations. Selection does not imply thumbs up/down, feedback does not imply selection, and feedback is not limited to dual-answer candidate runs.
